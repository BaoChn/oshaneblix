...
function App() {
	const brandPoints = [
		{
			title: "品牌定位",
			desc: "OSHANEBLIX 以婚纱礼服为核心，强调浪漫、优雅与现代质感，塑造更具辨识度的轻奢礼服品牌形象。",
		},
		{
			title: "视觉气质",
		...
		<div style={styles.page}>
			...
			<section style={styles.heroSection}>
				<div style={styles.heroGrid}>
					<div>
						<div style={styles.badge}>OSHANEBLIX · BRIDAL & EVENING DRESS</div>
						<h1 style={styles.heroTitle}>
							为 <span style={styles.italic}>OSHANEBLIX</span>
							<br />
							打造更有高级感的
					...
					<div style={styles.cardShell}>
						<div style={styles.cardGradient}>
							<div style={styles.cardInner}>
								...
								<div style={styles.cardBrand}>OSHANEBLIX</div>
			...
			<section style={styles.footerSection}>
				<div style={styles.footerCard}>
					<div>
						...
						<h2 style={styles.footerTitle}>OSHANEBLIX</h2>
						<p style={styles.footerDesc}>
							OSHANEBLIX 婚纱礼服基础品牌介绍页示意。可作为品牌官网首页雏形，也可进一步升级为带系列展示、预约试纱与联系表单的完整官网页面。
						</p>
					</div>
